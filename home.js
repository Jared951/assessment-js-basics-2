...
const canWeDeliver = (zipCode) => {
        if (deliveryAreaZipCodes.includes(zipCode)) {
            ...
            return `You are not elible for delivery`
        }
}

let zipCodeChecker = canWeDeliver(85205)
...
let zipCodeChecker2 = canWeDeliver(84010)
console.log(zipCodeChecker2)
...
const replacer = deals[0].title.replace('15', '10')
...
const replacer2 = deals[1].desc.replace('March', 'April').trim()
